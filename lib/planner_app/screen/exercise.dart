...
class _ExerciseState extends State<Exercise> with WidgetsBindingObserver {
  ...
  // ===== SharedPreferences keys (exercise) =====
  static const _kRunning = 'exercise_running';
  static const _kInitialMinutes = 'exercise_initial_minutes';
  static const _kSessionStartMs = 'exercise_session_start_ms';
  static const _kActiveStartMs = 'exercise_active_start_ms';
  static const _kAccumulatedSec = 'exercise_accumulated_sec';
    ...
    _ticker = Timer.periodic(const Duration(seconds: 1), (_) {
      ...
      if (!_targetNotified && _remainingNow().inSeconds <= 0 && !_dialogOpen) {
        ...
        ScaffoldMessenger.maybeOf(context)
          ...
          ..showSnackBar(
            const SnackBar(
              content: Text('Target reached! You can keep exercising 💪'),
            ),
          );
      }
    });
  ...
  Future<void> _saveExerciseSession({
    ...
    final ref = FirebaseFirestore.instance
        .collection('timer')
        .doc(uid)
        .collection('exercise_sessions') // ✅ แยก collection
        .doc();
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Icon(Icons.fitness_center, size: 40, color: Colors.grey[800]),
          ],
        ),
      ],
    );
